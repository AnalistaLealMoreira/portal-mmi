...
MIDDLEWARE = [
    ...
    "accounts.middleware.RestringirAcessoPorRedeMiddleware",
...
# E-mail de recuperação de senha. Em desenvolvimento, o console é mais seguro
# e permite validar o fluxo sem enviar mensagens reais.
EMAIL_BACKEND = env(
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@mminc.com.br")
